...
-(void)inputJsToHtml
{
    NSString *jsStr = [_webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"typeof window.%@ == 'object'", kBridgeName]];
    if (![jsStr isEqualToString:@"true"]) {
        ...
        [_webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:js, methodList]];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    NSLog(@"%@", html);
    //is js insert
    NSString *jsStr = [webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"typeof window.%@ == 'object'", kBridgeName]];
    if (![jsStr isEqualToString:@"true"]) {
        //get class method dynamically
        unsigned int methodCount = 0;
        Method *methods = class_copyMethodList([self class], &methodCount);
...
//        [webView stringByEvaluatingJavaScriptFromString:@"setTitle();"];
    }
